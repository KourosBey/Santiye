...
export default function Sidebar() {
  ...
  const links = [
    { href: '/employer/home', label: 'Anasayfa' },
    { href: '/employer/buy-package', label: 'İlan Paketi Satın Al' },
    { href: '/employer/create-job-post', label: 'İş İlanı Oluştur' },
    { href: '/employer/my-job-posts', label: 'İlanlarım' },
    { href: '/employer/account', label: 'Hesabım' },
    { href: '/employer/requests', label: 'İstek Ve Talepler' },
  ];
